...
may further refine it to trust one over the other.
...
from nanochat_jax.common import download_file_with_lock
...
class SpellingBee(Task):
    ...
    def get_example(self, index):
        ...
        for i, char in enumerate(word, 1):
            if char == letter:
                running_count += 1
                # there deliberately cannot be a space between i and char (different tokens)
